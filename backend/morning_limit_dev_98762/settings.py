"""
Django settings for morning_limit_dev_98762 project.
...
ROOT_URLCONF = 'morning_limit_dev_98762.urls'
...
WSGI_APPLICATION = 'morning_limit_dev_98762.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "morning_limit_dev_98762 API",
    "DESCRIPTION": "API documentation for morning_limit_dev_98762 App",
    "VERSION": "v1",
}
