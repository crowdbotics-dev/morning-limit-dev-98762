...
## Project Structure
    ...
    ├── morning_limit_dev_98762  # Django project configurations
...
1. Clone this repo and `cd morning_limit_dev_98762`
...
2. Clone this repo and `cd morning_limit_dev_98762`
